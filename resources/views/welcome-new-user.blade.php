		...
		<div>
				...
				<div>
				   ...
				   <h4>Confirm Account</h4>
						...
						<a style=" text-decoration: none;padding: 10px;background: #343a40;color: white;font-weight: bold;"href="https://plannerr-fbf4a.firebasssseapp.com/onboard/signup.html?confirm_token={{$user->confirm_token}}#workspace-tab" target="_blank">Account Activation</a>
				</div>
