...
class UserWorkSpacesController extends Controller
{
   ...
   public function store(Request $request, WorkSpace $workspace) {
     ...
     //Check if input have space between title
     if (ctype_space($request->input('title'))) {
       return repsonse()->json(['data' => ['error' => false, 'messsge' => 'invalid input format(Seperat text with "|")!']], 422);
     }
